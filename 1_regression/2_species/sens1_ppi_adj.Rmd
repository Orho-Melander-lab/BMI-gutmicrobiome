...
confounders_full <- c('age', 'country_birth', 'Cohort', 'physical_activity_f', 'smoking_f', 'metformin', 'diab_diag', 'Fiber', 'PPI')
```
...
## save results
```{r}
file_name <- here::here("results",paste0("results_linear_clr_ppi", results_version, ".xlsx"))
