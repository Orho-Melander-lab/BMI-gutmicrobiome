...
confounders_full <- c('age', 'country_birth', 'Cohort', 'physical_activity_f', 'smoking_f', 'metformin', 'diab_diag', 'Fiber', 'antibiotics')
```
...
## save results
```{r}
file_name <- here::here("results",paste0("results_linear_clr_ab", results_version, ".xlsx"))
